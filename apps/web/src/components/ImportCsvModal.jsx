...
const ImportCsvModal = ({
  ...
  const documentTypeBadge = useMemo(() => {
      switch (dryRunResult?.documentType) {
        ...
        case "credit_card_invoice_nubank":
          return { label: "Fatura Nubank", className: "border-violet-300 bg-violet-50 text-violet-700 dark:border-violet-700 dark:bg-violet-950/40 dark:text-violet-400" };
        default:
        return null;
    }
  }, [dryRunResult]);
