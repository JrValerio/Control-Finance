...
- S9.5 iniciada com smoke operacional ponta a ponta e checklist objetivo de prontidao (`scripts/smoke-tax-irpf-mvp.ps1` + `docs/runbooks/s9-5-smoke-irpf-mvp.md`), em fechamento residual.
- S9.6 permanece em pre-abertura, aguardando liberacao de gate (sem inicio formal de execucao).
...
- Evidencias da Sprint 9: PR #374, PR #375, PR #376, PR #377, PR #378, PR #381.
- Proxima linha: executar smoke real no ambiente-alvo, gerar pacote de evidencias e anexar artefatos para fechamento residual da S9.5 antes de liberar o gate formal da S9.6.
- Bloqueio conhecido: ausencia de evidencia operacional do smoke real anexada ao ciclo de fechamento da S9.5.
